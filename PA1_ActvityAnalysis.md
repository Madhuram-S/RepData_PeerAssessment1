...
```r
      # Calculate mean and median for total steps each day
      mean_stps <- round(mean(daywise_rpt_bf$total_stps),2)
      median_stps <- round(median(daywise_rpt_bf$total_stps),2)
```

The mean value is 1.076619 &times; 10<sup>4</sup> and median values is 1.0765 &times; 10<sup>4</sup>
